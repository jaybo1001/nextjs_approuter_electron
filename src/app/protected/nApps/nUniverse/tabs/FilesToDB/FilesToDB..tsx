...
const FilesToDB: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-slate-800/80 backdrop-blur-sm z-100">
      <div className="flex flex-col items-center">
        <h1 className="text-2xl font-bold mb-4 text-center text-white">Files to DB Sync</h1>
