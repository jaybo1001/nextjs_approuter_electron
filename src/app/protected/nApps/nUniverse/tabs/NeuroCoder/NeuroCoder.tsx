...
export default function NeuroCoder() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">NeuroCoder</h1>
      <Accordion>
        <AccordionItem key="create" aria-label="Create Neuron" title="Create Neuron">
          <NeuronForm
        ...
        <AccordionItem key="edit" aria-label="Edit Neuron" title="Edit Neuron">
          {editingNeuron ? (
            <NeuronEditForm
            ...
            <p>Select a neuron to edit</p>
          )}
        </AccordionItem>
        <AccordionItem key="list" aria-label="Neuron List" title="Neuron List">
          <NeuronList
            neurons={neurons}
            onEdit={setEditingNeuron}
