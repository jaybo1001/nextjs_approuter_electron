...
import { CleoWorkflowIcon } from "@/nComponents/Cockpit/nConsoleIcons/CleoWorkflowIcon";
import { NAbilitiesIcon } from "@/nComponents/Cockpit/nConsoleIcons/nAbilitiesIcon";
import { NKnowledgeIcon } from "@/nComponents/Cockpit/nConsoleIcons/nKnowledgeIcon";
import { NLogicIcon } from "@/nComponents/Cockpit/nConsoleIcons/nLogicIcon";
import { NTermIcon } from "@/nComponents/Cockpit/nConsoleIcons/nTermIcon";
import { NImageToTextIcon } from "@/nComponents/Cockpit/nConsoleIcons/NImageToTextIcon";
import { NImageClassificationIcon } from "@/nComponents/Cockpit/nConsoleIcons/NImageClassificationIcon";
import { NObjectDetectionIcon } from "@/nComponents/Cockpit/nConsoleIcons/NObjectDetectionIcon";
import { NTextToImageIcon } from "@/nComponents/Cockpit/nConsoleIcons/NTextToImageIcon";
import { NTextToSpeechIcon } from "@/nComponents/Cockpit/nConsoleIcons/NTextToSpeechIcon";
import { NTextToVideoIcon } from "@/nComponents/Cockpit/nConsoleIcons/NTextToVideoIcon";
import { NLanguageTranslationIcon } from "@/nComponents/Cockpit/nConsoleIcons/NLanguageTranslationIcon";
import { NSentimentAnalysisIcon } from "@/nComponents/Cockpit/nConsoleIcons/NSentimentAnalysisIcon";
import { NSummarizationIcon } from "@/nComponents/Cockpit/nConsoleIcons/NSummarizationIcon";
import { NQuestionAnsweringIcon } from "../nConsoleIcons/NQuestionAnsweringIcon";
import { NCodeGenerationIcon } from "@/nComponents/Cockpit/nConsoleIcons/NCodeGenerationIcon";
import { NImageEditingIcon } from "@/nComponents/Cockpit/nConsoleIcons/NImageEditingIcon";
import { N3DModelGenerationIcon } from "@/nComponents/Cockpit/nConsoleIcons/N3DModelGenerationIcon";
import { NTimeSeriesForecastingIcon } from "@/nComponents/Cockpit/nConsoleIcons/NTimeSeriesForecastingIcon";
import { NAnomalyDetectionIcon } from "@/nComponents/Cockpit/nConsoleIcons/NAnomalyDetectionIcon";
import { NStyleTransferIcon } from "@/nComponents/Cockpit/nConsoleIcons/NStyleTransferIcon";
import { NNamedEntityRecognitionIcon } from "@/nComponents/Cockpit/nConsoleIcons/NNamedEntityRecognitionIcon";
import { NSemanticSegmentationIcon } from "@/nComponents/Cockpit/nConsoleIcons/NSemanticSegmentationIcon";

import CleoWorkflow from "@/nComponents/Console/Console-tabs/CleoWorkflow/CleoWorkflow";
import NAbilities from "@/nComponents/Console/Console-tabs/nAbilities/nAbilities";
import NKnowledge from "@/nComponents/Console/Console-tabs/nKnowledge/nKnowledge";
import NLogic from "@/nComponents/Console/Console-tabs/nLogic/nLogic";
import NTerm from "@/nComponents/Console/Console-tabs/nTerm/nTerm";
import Home from "@/nComponents/Console/Console-tabs/home/home";
import NImageToText from "@/nComponents/Console/Console-tabs/nImageToText/nImageToText";
import NImageClassification from "@/nComponents/Console/Console-tabs/nImageClassification/nImageClassification";
import NObjectDetection from "@/nComponents/Console/Console-tabs/nObjectDetection/nObjectDetection";
import NTextToImage from "@/nComponents/Console/Console-tabs/nTextToImage/nTextToImage";
import NTextToSpeech from "@/nComponents/Console/Console-tabs/nTextToSpeech/nTextToSpeech";
import NTextToVideo from "@/nComponents/Console/Console-tabs/nTextToVideo/nTextToVideo";
import NLanguageTranslation from "@/nComponents/Console/Console-tabs/nLanguageTranslation/nLanguageTranslation";
import NSentimentAnalysis from "@/nComponents/Console/Console-tabs/nSentimentAnalysis/nSentimentAnalysis";
import NSummarization from "@/nComponents/Console/Console-tabs/nSummarization/nSummarization";
import NQuestionAnswering from "@/nComponents/Console/Console-tabs/nQuestionAnswering/nQuestionAnswering";
import NCodeGeneration from "@/nComponents/Console/Console-tabs/nCodeGeneration/nCodeGeneration";
import NImageEditing from "@/nComponents/Console/Console-tabs/nImageEditing/nImageEditing";
  import N3DModelGeneration from "@/nComponents/Console/Console-tabs/n3DModelGeneration/n3DModelGeneration";
import NTimeSeriesForecasting from "@/nComponents/Console/Console-tabs/nTimeSeriesForecasting/nTimeSeriesForecasting";
import NAnomalyDetection from "@/nComponents/Console/Console-tabs/nAnomalyDetection/nAnomalyDetection";
import NStyleTransfer from "@/nComponents/Console/Console-tabs/nStyleTransfer/nStyleTransfer";
import NNamedEntityRecognition from "@/nComponents/Console/Console-tabs/nNamedEntityRecognition/nNamedEntityRecognition";
import NSemanticSegmentation from "@/nComponents/Console/Console-tabs/nSemanticSegmentation/nSemanticSegmentation";
