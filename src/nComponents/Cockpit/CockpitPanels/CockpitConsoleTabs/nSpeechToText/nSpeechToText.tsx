...
const NSpeechToText: React.FC = () => {
  ...
  return (
    <div className="nSpeechToText flex flex-col h-full w-full bg-black text-white p-4">
      <h2 className="text-2xl font-bold mb-4">Speech to Text</h2>
      <motion.img
        src="/SpeechToText_concept.svg"
        alt="Speech to Text Workflow"
