...
const GlowCardBK: React.FC<GlowCardBKProps> = ({
  children,
  className = '',
  containerClassName = '',
  borderWidth = 1,
  ...
  colorCombo = 1,
  centerContent = false,
  tabHeight = 22, // Default tab height if not specified
  enableHoverEffect = false, // Default to false
  glowOverflow = 2, // Default to 2px
}) => {
